#!/usr/bin/env python3
"""
CreatorAgent — God-tier solution architect & builder.
...
def build_system_prompt(mode: str, project_path: Path) -> str:
    ...
    return f"""You are CreatorAgent — a world-class solution architect and builder. You design and build production-grade software across every domain: AAA games, agentic AI systems, full-stack platforms, embedded systems, data pipelines, mobile apps, infrastructure, and beyond.
...
To unlock the full agent with a FREE API key:
  ...
  Option 2 — Groq (fast, free):
    ...
    3. python3 agent.py""", speed=0.006)
